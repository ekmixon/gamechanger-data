...
def run(staging_folder: str, input_list_file: str, output_file: str):
    ...
    for directory in directories:
        ...
        query_files_processed = {
            'query': {'wildcard': {'gc_path_s': {'value': f'{directory}*'}}}
        }
        ...
        query_ocr_count = {
            'query': {
                'bool': {
                    'must': [
                        {'term': {'is_ocr_b': {'value': 'true'}}},
                        {
                            'wildcard': {
                                'gc_path_s': {'value': f'{directory}*'}
                            }
                        },
                    ]
                }
            ...
            'query': {
                'bool': {
                    'must': [
                        ...
                        {
                            'wildcard': {
                                'gc_path_s': {'value': f'{directory}*.txt'}
                            }
                        },
                    ]
                }
            ...
            'query': {
                'bool': {
                    'must': [
                        ...
                        {
                            'wildcard': {
                                'gc_path_s': {'value': f'{directory}*.pdf'}
                            }
                        },
                    ]
                }
        ...
        query_pds = {
            'query': {
                'bool': {
                    'must_not': [
                        {'term': {'completed': {'value': 'completed'}}}
                    ],
                    'must': [
                        {
                            'wildcard': {
                        ...
                        {'term': {'metadata_type_s': {'value': 'pds'}}},
                        {'term': {'is_metadata_suc_b': {'value': 'true'}}},
                        {
                            'term': {
            ...
            'query': {
                'bool': {
                    ...
                    'must': [
                        ...
                        {'term': {'metadata_type_s': {'value': 'pds'}}},
                        {'term': {'is_metadata_suc_b': {'value': 'false'}}},
                        {
                            'term': {
                                'is_supplementary_file_missing': {
                                    'value': 'true'
            ...
            'query': {
                'bool': {
                    ...
                    'must': [
                        ...
                        {'term': {'metadata_type_s': {'value': 'syn'}}},
                        {'term': {'is_metadata_suc_b': {'value': 'true'}}},
                        {
                            'term': {
                                'is_supplementary_file_missing': {
...
def get_es_publisher(staging_folder: str, index_name: str, alias: str) -> ConfiguredElasticsearchPublisher:
    return ConfiguredElasticsearchPublisher(
        index_name=index_name, ingest_dir=staging_folder, alias=alias
    )
